...
CHAINBASE_SET_INDEX_TYPE(koinos::chain::table_id_object, koinos::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(koinos::chain::key_value_object, koinos::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(koinos::chain::index64_object, koinos::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(koinos::chain::index128_object, koinos::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(koinos::chain::index256_object, koinos::chain::index256_index)
...
REFLECT_SECONDARY(koinos::chain::index256_object)
REFLECT_SECONDARY(koinos::chain::index_double_object)
REFLECT_SECONDARY(koinos::chain::index_long_double_object)
